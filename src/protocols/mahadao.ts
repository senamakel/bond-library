...
export default {
  ...
  description: "MahaDAO is a blockchain-based, community governed investment platform and decentralized venture capital fund.", // A short protocol description
  ...
  */
  issuerAddresses: {
    [CHAIN_ID.ETHEREUM_MAINNET]: ["0x77cd66d59ac48a0E7CE54fF16D9235a5fffF335E", "0x6357EDbfE5aDA570005ceB8FAd3139eF5A8863CC"],
  },
  ...
  tokens: [
    {
      ...
      purchaseLinks: { [CHAIN_ID.ARBITRUM_MAINNET]: "https://app.uniswap.org/#/swap?outputCurrency=0x745407c86df8db893011912d3ab28e68b62e49b0" }, // Where to acquire your token
      priceSources: [
